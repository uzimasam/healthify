    ...
    return (
        <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
                ...
                <CardContent>
                    <div className="space-y-4">
                        {summaryData.topHospitals.map((hospital, index) => (
                            <div key={index} className="space-y-2">
                                <div className="flex items-center justify-between">
                                    <span className="font-medium">{hospital.name}</span>
                                    <span>{"⭐".repeat(Math.round(hospital.rating))}</span>
                                </div>
                                <div className="text-sm text-gray-500">
                                    {hospital.orders} orders · ${hospital.value.toLocaleString()}
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <CardContent>
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="text-2xl font-bold">{summaryData.performance.customerSatisfaction}/5.0</div>
                        </div>
                        <div>
